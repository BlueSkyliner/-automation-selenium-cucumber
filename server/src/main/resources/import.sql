...
INSERT INTO `board` (id, user_id, is_approve, title, producer, distributor, poster_img, view_link, info_country, info_created_year, info_created_date, info_time, info_limit, info_story, info_subtitle) VALUES(51,2,true,"원룸","이병진",null,"https://user-images.githubusercontent.com/45745049/141710189-4f2c509b-6a6a-40be-a70a-4217dcb62542.png","https://youtu.be/tyXxjw_SyxE","한국","2018",null,26,1,"<p>야근 때문에 자주 원룸을 비우는 일한은 원룸의 반나절 세입자를 구한다.</p><p>고교 자퇴생 준은 뮤지션의 꿈을 위해 서울로 상경하고 일한의 반나절 룸메이트가 된다.</p><p>두 사람의 예민한 반나절 동거에 준의 고향 친구 병두가 나타나는데...</p>"